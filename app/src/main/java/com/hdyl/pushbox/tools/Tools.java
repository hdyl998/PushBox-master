...
public class Tools {
    ...
    public static List<String> getClassNames(String packageName) {
        ...
        try {
            ...
            DexFile df = new DexFile(App.instance.getPackageCodePath());// 通过DexFile查找当前的APK中可执行文件
    ...
    public static String list2String(List<String> lists, String seprate) {
